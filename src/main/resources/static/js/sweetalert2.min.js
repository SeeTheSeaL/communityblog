!function (e, t) {
    ...
    var e = {
        ...
        r = n(["success", "warning", "info", "question", "error"]), i = function (e, t) {
            ...
            t.className = o.container, t.innerHTML = s, document.body.appendChild(t);
            var n = c(), r = A(n, o.input), i = A(n, o.file), a = n.querySelector("." + o.range + " input"),
                l = n.querySelector("." + o.range + " output"), u = A(n, o.select),
                d = n.querySelector("." + o.checkbox + " input"), p = A(n, o.textarea);
            return r.oninput = function () {
                ...
                X.resetValidationError(), l.value = a.value
            }, a.onchange = function () {
                X.resetValidationError(), a.previousSibling.value = a.value
            }, u.onchange = function () {
                X.resetValidationError()
            }, d.onchange = function () {
                X.resetValidationError()
        ...
        u = function () {
            ...
            var a = f(), s = m(), u = b(), p = w(), g = C();
            if (t.titleText ? a.innerText = t.titleText : a.innerHTML = t.title.split("\n").join("<br>"), t.text || t.html) {
                if ("object" === j(t.html)) if (s.innerHTML = "", 0 in t.html) for (var k = 0; k in t.html; k++) s.appendChild(t.html[k].cloneNode(!0)); else s.appendChild(t.html.cloneNode(!0)); else t.html ? s.innerHTML = t.html : t.text && (s.textContent = t.text);
                P(s)
            } else T(s);
            t.showCloseButton ? P(g) : T(g), n.className = o.modal, t.customClass && E(n, t.customClass);
            var x = y(), S = parseInt(null === t.currentProgressStep ? X.getQueueStep() : t.currentProgressStep, 10);
            ...
            var n = u(), r = c();
            e ? (E(r, o.show), E(n, o.fade), B(r, o.hide)) : B(r, o.fade), P(r), n.style.overflowY = "hidden", O && !x(r, o.noanimation) ? r.addEventListener(O, function e() {
                r.removeEventListener(O, e), n.style.overflowY = "auto"
            ...
            switch (j(n[0])) {
                case"string":
                    s.title = n[0], s.html = n[1], s.type = n[2];
                    break;
                case"object":
                    K(s, n[0]), s.extraParams = n[0].extraParams, "email" === s.input && null === s.inputValidator && (s.inputValidator = function (e) {
                    ...
                    break;
                default:
                    return console.error('SweetAlert2: Unexpected type of argument! Expected "string" or "object", got ' + j(n[0])), !1
            }
            R(s);
            var d = u(), p = c();
            return new Promise(function (t, n) {
                s.timer && (p.timeout = setTimeout(function () {
                    e.closeModal(s.onClose), n("timer")
                }, s.timer));
                var r = function (e) {
                    if (e = e || s.input, !e) return null;
                    switch (e) {
                        case"select":
                        case"textarea":
                        case"file":
                ...
                for (var L = function (n) {
                    ...
                    }) : (e.closeModal(s.onClose), t(n))
                }, q = function (t) {
                    var o = t || window.event, r = o.target || o.srcElement, a = b(), l = w(), u = a === r || a.contains(r),
                        c = l === r || l.contains(r);
                    switch (o.type) {
                        case"mouseover":
                        case"mouseup":
                            s.buttonsStyling && (u ? a.style.backgroundColor = i(s.confirmButtonColor, -.1) : c && (l.style.backgroundColor = i(s.cancelButtonColor, -.1)));
                            break;
                        case"mouseout":
                            s.buttonsStyling && (u ? a.style.backgroundColor = s.confirmButtonColor : c && (l.style.backgroundColor = s.cancelButtonColor));
                            break;
                        case"mousedown":
                            s.buttonsStyling && (u ? a.style.backgroundColor = i(s.confirmButtonColor, -.2) : c && (l.style.backgroundColor = i(s.cancelButtonColor, -.2)));
                            break;
                        case"click":
                            u && e.isVisible() ? (e.disableButtons(), s.input ? !function () {
                                var t = x();
                                s.inputValidator ? (e.disableInput(), s.inputValidator(t, s.extraParams).then(function () {
                                    e.enableButtons(), e.enableInput(), L(t)
                                }, function (t) {
                                    e.enableButtons(), e.enableInput(), t && e.showValidationError(t)
                                })) : L(t)
                            }() : L(!0)) : c && e.isVisible() && (e.disableButtons(), e.closeModal(s.onClose), n("cancel"))
                    }
                }, O = p.querySelectorAll("button"), H = 0; H < O.length; H++) O[H].onclick = q, O[H].onmouseover = q, O[H].onmouseout = q, O[H].onmousedown = q;
                C().onclick = function () {
                    e.closeModal(s.onClose), n("close")
                }, d.onclick = function (t) {
                    t.target === d && s.allowOutsideClick && (e.closeModal(s.onClose), n("overlay"))
                };
                var I = b(), K = w();
                s.reverseButtons ? I.parentNode.insertBefore(K, I) : I.parentNode.insertBefore(I, K);
                var D = function (e, t) {
                    ...
                    var o = t || window.event, r = o.keyCode || o.which;
                    if ([9, 13, 32, 27].indexOf(r) !== -1) {
                        for (var i = o.target || o.srcElement, a = k(s.focusCancel), l = -1, u = 0; u < a.length; u++) if (i === a[u]) {
                            l = u;
                            break
                        }
                        9 === r ? (o.shiftKey ? D(l, -1) : D(l, 1), o.stopPropagation(), o.preventDefault()) : 13 === r || 32 === r ? l === -1 && s.allowEnterKey && (s.focusCancel ? V(K, o) : V(I, o)) : 27 === r && s.allowEscapeKey === !0 && (e.closeModal(s.onClose), n("esc"))
                    }
                };
                a.previousWindowKeyDown = window.onkeydown, window.onkeydown = W, s.buttonsStyling && (I.style.borderLeftColor = s.confirmButtonColor, I.style.borderRightColor = s.confirmButtonColor), e.showLoading = e.enableLoading = function () {
                    P(h()), P(I, "inline-block"), E(I, o.loading), E(p, o.loading), I.disabled = !0, K.disabled = !0
                }, e.hideLoading = e.disableLoading = function () {
                    s.showConfirmButton || (T(I), s.showCancelButton || T(h())), B(I, o.loading), B(p, o.loading), I.disabled = !1, K.disabled = !1
                }, e.getTitle = function () {
                    return f()
                    ...
                    I.disabled = !1, K.disabled = !1
                }, e.disableButtons = function () {
                    I.disabled = !0, K.disabled = !0
                ...
                for (var Q = ["input", "file", "range", "select", "radio", "checkbox", "textarea"], Y = void 0, Z = 0; Z < Q.length; Z++) {
                    var J = o[Q[Z]], X = A(p, J);
                    if (Y = r(Q[Z])) {
                        for (var $ in Y.attributes) if (Y.attributes.hasOwnProperty($)) {
                            var _ = Y.attributes[$].name;
                            "type" !== _ && "value" !== _ && Y.removeAttribute(_)
                        }
                        for (var F in s.inputAttributes) Y.setAttribute(F, s.inputAttributes[F])
                    }
                    X.className = J, s.inputClass && E(X, s.inputClass), T(X)
                }
                var G = void 0;
                !function () {
                    switch (s.input) {
                        ...
                        case"number":
                        case"tel":
                            Y = A(p, o.input), Y.value = s.inputValue, Y.placeholder = s.inputPlaceholder, Y.type = s.input, P(Y);
                            break;
                        case"file":
                            Y = A(p, o.file), Y.placeholder = s.inputPlaceholder, Y.type = s.input, P(Y);
                            break;
                        case"range":
                            var e = A(p, o.range), t = e.querySelector("input"), n = e.querySelector("output");
                            t.value = s.inputValue, t.type = s.input, n.value = s.inputValue, P(e);
                            break;
                        case"select":
                            var i = A(p, o.select);
                            if (i.innerHTML = "", s.inputPlaceholder) {
                                var a = document.createElement("option");
                                a.innerHTML = s.inputPlaceholder, a.value = "", a.disabled = !0, a.selected = !0, i.appendChild(a)
                            }
                            G = function (e) {
                                for (var t in e) {
                                    var n = document.createElement("option");
                                    n.value = t, n.innerHTML = e[t], s.inputValue === t && (n.selected = !0), i.appendChild(n)
                                }
                                P(i), i.focus()
                            };
                            break;
                        case"radio":
                            var l = A(p, o.radio);
                            l.innerHTML = "", G = function (e) {
                                for (var t in e) {
                                    var n = document.createElement("input"), r = document.createElement("label"),
                                        i = document.createElement("span");
                                    n.type = "radio", n.name = o.radio, n.value = t, s.inputValue === t && (n.checked = !0), i.innerHTML = e[t], r.appendChild(n), r.appendChild(i), r.for = n.id, l.appendChild(r)
                                }
                                P(l);
                                var a = l.querySelectorAll("input");
                                a.length && a[0].focus()
                            };
                            break;
                        case"checkbox":
                            var u = A(p, o.checkbox), c = r("checkbox");
                            c.type = "checkbox", c.value = 1, c.id = o.checkbox, c.checked = Boolean(s.inputValue);
                            var d = u.getElementsByTagName("span");
                            d.length && u.removeChild(d[0]), d = document.createElement("span"), d.innerHTML = s.inputPlaceholder, u.appendChild(d), P(u);
                            break;
                        case"textarea":
                            var f = A(p, o.textarea);
                            f.value = s.inputValue, f.placeholder = s.inputPlaceholder, P(f);
                            break;
                        case null:
                            break;
                        default:
                            console.error('SweetAlert2: Unexpected type of input! Expected "text", "email", "password", "select", "checkbox", "textarea" or "file", got "' + s.input + '"')
                    }
                }(), "select" !== s.input && "radio" !== s.input || (s.inputOptions instanceof Promise ? (e.showLoading(), s.inputOptions.then(function (t) {
                    e.hideLoading(), G(t)
                })) : "object" === j(s.inputOptions) ? G(s.inputOptions) : console.error("SweetAlert2: Unexpected type of inputOptions! Expected object or Promise, got " + j(s.inputOptions))), z(s.animation, s.onOpen), s.allowEnterKey ? D(-1, 1) : document.activeElement && document.activeElement.blur(), u().scrollTop = 0, "undefined" == typeof MutationObserver || U || (U = new MutationObserver(e.recalculateHeight), U.observe(p, {
                    childList: !0,
                    characterData: !0,
                    subtree: !0
                }))
    ...
    return X.isVisible = function () {
        ...
        if (n) {
            ...
            var r = function () {
                document.body.removeChild(t), B(document.documentElement, o.shown), B(document.body, o.shown), Y(), J()
            };
            O && !x(n, o.noanimation) ? n.addEventListener(O, function e() {
                n.removeEventListener(O, e), x(n, o.hide) && r()
